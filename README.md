...
TestCafé end-to-end test automation boilerplate, Using [Commonjs](https://requirejs.org/docs/commonjs.html), [Chai](https://www.chaijs.com) and [Commonjs](https://www.chaijs.com/api/assert/).
